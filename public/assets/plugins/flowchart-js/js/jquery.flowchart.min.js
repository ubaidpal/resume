$(function () {
    $.widget("flowchart.flowchart", {
        ...
        _unitVariables: function () {
            this.data = {operators: {}, links: {}}, this.objs = {
        ...
        createLink: function (t, e) {
            ...
            if (this.callbackEvent("linkCreate", [t, r])) {
                var o = this._getSubConnectors(r), n = o[0], a = o[1], i = this.options.multipleLinksOnOutput,
                    s = this.options.multipleLinksOnInput;
                if (!i || !s) for (var l in this.data.links) if (this.data.links.hasOwnProperty(l)) {
                    var c = this.data.links[l], p = this._getSubConnectors(c), u = p[0], h = p[1];
        ...
        getConnectorPosition: function (t, e, r) {
            var o = this.data.operators[t], n = o.internal.els.connectorArrows[e][r], a = n.offset(), i = this.element.offset(),
                s = (a.left - i.left) / this.positionRatio, l = parseInt(n.css("border-top-width")),
                c = (a.top - i.top - 1) / this.positionRatio + parseInt(n.css("border-left-width"));
            return {x: s, width: l, y: c}
        },
        getLinkMainColor: function (t) {
            var e = this.options.defaultLinkColor, r = this.data.links[t];
        ...
        _drawLink: function (t) {
            ...
            var r = e.fromOperator, o = e.fromConnector, n = e.toOperator, a = e.toConnector, i = this._getSubConnectors(e), s = i[0],
                l = i[1], p = (this.getLinkMainColor(t), this.data.operators[r]), u = this.data.operators[n],
                h = p.internal.els.connectorSmallArrows[o][s], d = u.internal.els.connectorSmallArrows[a][l];
            ...
            var v = document.createElementNS("http://www.w3.org/2000/svg", "mask"), k = "fc_mask_" + this.globalId + "_" + this.maskNum;
        ...
        _refreshLinkPositions: function (t) {
            var e = this.data.links[t], r = this._getSubConnectors(e), o = r[0], n = r[1],
                a = this.getConnectorPosition(e.fromOperator, e.fromConnector, o),
                i = this.getConnectorPosition(e.toOperator, e.toConnector, n), s = a.x, l = a.width, c = a.y, p = i.x, u = i.y;
            ...
            var d = s + l + h, f = p + 1, v = Math.min(100, Math.max(Math.abs(d - f) / 2, Math.abs(c - u)));
        ...
        _getOperatorFullElement: function (t) {
            ...
            var e = this.getOperatorCompleteData(t), r = $('<div class="flowchart-operator"></div>');
            r.addClass(e["class"]);
        ...
        _createSubConnector: function (t, e, r) {
            var o = r.connectorSets[t], n = r.connectors[t].length, a = $('<div class="flowchart-operator-connector"></div>');
        ...
        createOperator: function (t, e) {
            function a(t, r) {
                ...
                for (var o in n.data.links) if (n.data.links.hasOwnProperty(o)) {
            ...
            if (this.options.canUserMoveOperators) {
                ...
                r.operator.draggable({
                    ...
                    drag: function (t, o) {
                        if (n.options.grid) {
                            var l = n.options.grid, c = n.element.offset();
        ...
        _connectorClicked: function (t, e, r, o) {
            if ("outputs" == o) {
                ...
                var a = this.getConnectorPosition(t, e, r), i = a.x + a.width, s = a.y;
        ...
        callbackEvent: function (t, e) {
            var r = "on" + t.charAt(0).toUpperCase() + t.slice(1), o = this.options[r].apply(this, e);
            if (o !== !1) {
                var n = {result: o};
        ...
        _shadeColor: function (t, e) {
            var r = parseInt(t.slice(1), 16), o = 0 > e ? 0 : 255, n = 0 > e ? -1 * e : e, a = r >> 16, i = r >> 8 & 255, s = 255 & r;
        ...
        _deleteOperator: function (t, e) {
            ...
            if (!e) for (var r in this.data.links) if (this.data.links.hasOwnProperty(r)) {
        ...
        _deleteLink: function (t, e) {
            if (this.selectedLinkId == t && this.unselectLink(), this.callbackEvent("linkDelete", [t, e]) || e) {
                ...
                var r = this.data.links[t], o = r.fromOperator, n = r.fromConnector, a = r.toOperator, i = r.toConnector;
        ...
        _cleanMultipleConnectors: function (t, e, r) {
            if (this.data.operators[t].properties["from" == r ? "outputs" : "inputs"][e].multiple) {
                var o = -1, n = r + "Operator", a = r + "Connector", i = r + "SubConnector", s = this.data.operators[t].internal.els,
                    l = s.connectors[e], c = l.length;
                for (var p in this.data.links) if (this.data.links.hasOwnProperty(p)) {
        ...
        setOperatorData: function (t, e) {
            ...
            for (var o in this.data.links) if (this.data.links.hasOwnProperty(o)) {
        ...
        getOperatorFullProperties: function (t) {
            if ("undefined" != typeof t.type) {
                var e = this.data.operatorTypes[t.type], r = {};
