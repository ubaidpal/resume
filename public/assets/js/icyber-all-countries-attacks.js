...
handlePieAndDonutCountryChart = function(id ,pieChartData) {
...
var DonutLoad = function($scope, $http, url){
   ...
   $http({
       ...
       $scope.countryAttack = response.countryAttack;
       var pieChartData = $scope.pieData;
       handlePieAndDonutCountryChart('nv-pie-chart-country-attacks' ,pieChartData);
       return false;
...
var show_loading_block = function (loading_message) {
