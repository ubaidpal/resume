...
var handlePanelAction = function() {
    ...
    $(document).on('click', '[data-click=panel-expand]', function(e) {
        ...
        if ($('body').hasClass('panel-expand') && $(target).hasClass('panel-expand')) {
            ...
            var dHeight = target.data('height');
            if(dHeight){
                target.css('height', dHeight);
            }

            var panelHeight = targetBody.data('body-height');
            if(panelHeight){
                targetBody.css('height', panelHeight);
            }
        } else {
...
var handleDraggablePanel = function() {
    var target = $('.dashboard-widgets');
    var targetHandle = '.panel-heading, .chart-title';
    var connectedTarget = '.dashboard-widgets';
    $(target).sortable({
        handle: targetHandle,
